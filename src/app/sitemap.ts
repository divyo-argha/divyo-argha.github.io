...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { url: `${siteConfig.url}/cyqured/`, priority: 0.8 },
    { url: `${siteConfig.url}/cyqured/assets/`, priority: 0.6 },
    { url: `${siteConfig.url}/cyqured/mechanics/`, priority: 0.7 },
    { url: `${siteConfig.url}/cyqured/publication/`, priority: 0.7 },
